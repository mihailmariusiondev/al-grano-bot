...
HELP_MESSAGE = (
    ...
    "• **Acceso al Comando `/summarize`:**\n"
    "    · Todos los usuarios pueden resumir el historial del chat y mensajes de texto.\n"
    "    · La capacidad de resumir contenido multimedia (audio, video, documentos, URLs de YouTube/artículos) está disponible para usuarios Premium y Administradores. Los usuarios gratuitos podrán tener acceso limitado o promocional a estas funciones en el futuro.\n\n"
    "🔹 **Notas Importantes:**\n"
